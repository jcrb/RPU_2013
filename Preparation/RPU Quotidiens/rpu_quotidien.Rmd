...
Transformer unr liste de **.sql** en **.csv**
==============================================

On veut tansformer une liste fichier .sql stocké dans Archives_Sagec stockés dans dataQ en fichier .csv qui seront enregistrés dans dataQ/archivesCsv. Les fichier .sql sont désignés par leur date de production (un fichier contient 7 jours glissants. Seul le 7ème est considéré comme consolidé et est enregistré dans .csv).
...
+ }
```
Pour assembler tous les fichiers .csv de archivesCsv:

assemble()

Transformer le fichier obtenu en dataframe:

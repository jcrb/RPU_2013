...
x <- xtable(t, caption=c("Orientation des patients non hospitalisés. Certaines orientation sont incompatibles avec un retour à domicile (Défaut de cohérence).","Orientation des patients non hospitalisés"),label="tab:orient_nh")

...
<<bp_parmois, echo=FALSE, fig.height=5>>=
  ...
  barplot(table(m),ylab="nombre",xlab="mois",main=main,names.arg=c("Jan","Fev","Mar","Avr","Mai","Jui","Jul","Aou","Sep","Oct","Nov","Dec"),las=2)
@
\captionof{figure}{\Sexpr{main}.}
...
c <- xtable(as.data.frame(b),caption=c("Activité des SU par semaine en 2013","Activité par semaine"))
print.xtable(c) # b, include.colnames=FALSE
...
barplot(table(m),names.arg=c("Dim","Lun","Mar","Mer","Jeu","Ven","Sam"), main=main)
@
\captionof{figure}{\Sexpr{main}.}

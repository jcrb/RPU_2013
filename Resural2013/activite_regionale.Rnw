...
print(xtable(t2,,caption=c(paste0("RPU par service d'urgence en ", anc),"Nombre de RPU par service d'urgence"),label="fig:passage_su",align=c("r","c","r"), display = c("s","s","f"), digits = 0),format.args = list(big.mark = " ", decimal.mark = ","))

...
print(xtable(table(RPU.mois), caption=c(paste0("Ativité mensuelle en nombre de RPU en ", anc),"RPU par mois")), format.args = list(big.mark = " ", decimal.mark = ","))
...
print(xtable(table(RPU.jour.semaine), caption=c(paste0("Ativité selon le jour de la semaine en nombre de RPU en ", anc),"RPU par jour de semaine")), format.args = list(big.mark = " ", decimal.mark = ","), comment = FALSE)
@

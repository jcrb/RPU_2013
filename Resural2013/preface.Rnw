...
Ce document analyse les Résumé de Passages aux Urgences (RPU) transmis en \Sexpr{anc} au réseau des urgences en Alsace. C'est le premier du genre et comme tel il forcément bien imparfait, à la fois qualitativement et quantitativement.

...
<<avc_jour_semaine,echo=FALSE,comment="", results='asis'>>=
library("gdata")
...
\index{AVC!âge}
<<avc_age,echo=FALSE, comment="", results='asis'>>=
# summary(AVC$AGE)
...
<<avc_sexe,echo=FALSE, comment="", results='asis'>>=
sr <- sexr(AVC$SEXE)

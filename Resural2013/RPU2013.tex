...
\begin{itemize}\raggedright
  ...
  \item Loaded via a namespace (and not attached): evaluate~0.5.5,
    formatR~0.10, stringr~0.6.2, tools~3.1.1
\end{itemize}
...
Les HUS sont le seul établissement d'Alsace a posséder un SU pédiatrique labellisé. Les HUS ont également un service labellisé urgences main (FESUM) situé au CCOM d'Illkirch mais ce dernier n'a pas l'autorisation d'activité de soins de médecine d'urgence. Tpos les services SOS Mins d'Alsace sont labellisé par la FESUM\footnote{Fédération Européenne des Services d'Urgence de la Main}.
...
Passages par territoire de santé:
...
\end{knitrout}
\captionof{figure}{Passages en SU en 2013.}
...
\end{knitrout}
\captionof{figure}{Passages en SU en2013.}
...
\end{knitrout}
\captionof{figure}{SU d'Alsace: nombre de passages en 2013.}
...
Jan & 26 858 \\ 
  ...
  Dec & 29 922 \\ 
   \hline
\end{tabular}
\caption[RPU par mois]{Ativité mensuelle en nombre de RPU en 2013} 
\end{table}
...
\end{knitrout}
\captionof{figure}{Activité selon le jour de la semaine en 2013.}
...
\captionof{figure}{Répartition des passages (en pourcentage)
 en fonction de l'heure d'entrée - sortie du patient aux urgences2013.}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/graphe_es_we} 
...
\end{knitrout}
\captionof{figure}{Pyramide des âges des consultants aux urgences comparés à la population générale. Les âges extrêmes fréquentent davantage les SU}
...
\end{knitrout}
\captionof{figure}{Taux de recours aux urgences selon la classe d'age. Le taux de recours est le rapport du nombre de consultants dans une classe d'âge donnée, à l'effectif de cette classe dans la population alsacienne.}
...
\end{knitrout}
 \captionof{figure}{Durée moyenne de passage aux urgences en 2013}
\end{center}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
Nombre d'AVC selon le jour de la semaine
Dim Lun Mar Mer Jeu Ven Sam 
323 467 457 399 396 408 350 
Pourcentage d'AVC selon le jour de la semaine
Dim Lun Mar Mer Jeu Ven Sam 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/asthme_age} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/asthme_ccmu} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/malaises_invs} 
...
{\centering \includegraphics[width=\maxwidth]{figure/ge_hist} 
...
{\centering \includegraphics[width=\maxwidth]{figure/ge_age_box} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/ge_epidemio} 
...
{\centering \includegraphics[width=\maxwidth]{figure/invs_barplot} 
...
% Date and time: mer., août 20, 2014 - 14:35:08

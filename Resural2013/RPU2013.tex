...
1 & 3Fr & 15 688 \\ 
  ...
  12 & Sav & 12 424 \\ 
   \hline
\end{tabular}
\caption[Nombre de RPU par service d'urgence]{RPU par service d'urgence en 2013} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/mois_nomalise} 
...
\end{knitrout}
\captionof{figure}{Taux de recours aux urgences selon la classe d'age. Le taux de recours est le rapport du nombre de RPU dans une classe d'âge donnée, à l'effectif de cette classe dans la population alsacienne.}
...
Dans 1 \% des cas, l'origine du patient n'est pas précisée.
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/avc_age21} 

\includegraphics[width=\maxwidth]{figure/avc_age22} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/avc_sexe21} 

\includegraphics[width=\maxwidth]{figure/avc_sexe22} 
...
% Date and time: sam., août 30, 2014 - 14:40:28

...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: there is no package called 'stargazer'}}\begin{alltt}
...
\hlstd{d1}\hlopt{$}\hlstd{secteur[d1}\hlopt{$}\hlstd{FINESS} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"Wis"}\hlstd{,} \hlstr{"Hag"}\hlstd{,} \hlstr{"Sav"}\hlstd{)]} \hlkwb{<-} \hlnum{1}
\hlstd{d1}\hlopt{$}\hlstd{secteur[d1}\hlopt{$}\hlstd{FINESS} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"Hus"}\hlstd{,} \hlstr{"Odi"}\hlstd{)]} \hlkwb{<-} \hlnum{2}
\hlstd{d1}\hlopt{$}\hlstd{secteur[d1}\hlopt{$}\hlstd{FINESS} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"Sel"}\hlstd{,} \hlstr{"Col"}\hlstd{,} \hlstr{"Geb"}\hlstd{)]} \hlkwb{<-} \hlnum{3}
\hlstd{d1}\hlopt{$}\hlstd{secteur[d1}\hlopt{$}\hlstd{FINESS} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"Mul"}\hlstd{,} \hlstr{"Alk"}\hlstd{,} \hlstr{"3Fr"}\hlstd{,} \hlstr{"Dia"}\hlstd{)]} \hlkwb{<-} \hlnum{4}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'object' lors de la sélection d'une méthode pour la fonction 'summary' : Erreur dans data\$total : objet de type 'closure' non indiçable}}\begin{verbatim}
## [1] 300
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: objet 'hosp' introuvable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: objet 'hosp' introuvable}}\begin{verbatim}
## NULL
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'object' lors de la sélection d'une méthode pour la fonction 'summary' : Erreur dans data\$hosp : objet de type 'closure' non indiçable}}\end{kframe}
\end{knitrout}


Le SU Sainte Anne a reçu en 2013 un total de \np{1204} consultants, soit en moyenne 1 par jour.

% latex table generated in R 3.0.2 by xtable 1.7-1 package
% Tue Dec 24 16:48:46 2013
\begin{table}[ht]
\centering
\begin{tabular}{}
  \hline
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: "{}x"{} : attempt to define invalid zoo object}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: "{}x"{} : attempt to define invalid zoo object}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'x' lors de la sélection d'une méthode pour la fonction 'plot' : Erreur : objet 'ma' introuvable}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'x' lors de la sélection d'une méthode pour la fonction 'plot' : Erreur dans ts\$total : objet de type 'closure' non indiçable}}
...
Le taux moyen d'hospitalisation \footnote{L'hospitalisation est la somme des mutations, transferts et UHCD.} est de 300\% par jour.
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: "{}x"{} : attempt to define invalid zoo object}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'object' lors de la sélection d'une méthode pour la fonction 'summary' : Erreur dans data\$total : objet de type 'closure' non indiçable}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'object' lors de la sélection d'une méthode pour la fonction 'summary' : Erreur dans data\$entre1\_75ans : objet de type 'closure' non indiçable}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: erreur d'évaluation de l'argument 'object' lors de la sélection d'une méthode pour la fonction 'summary' : Erreur dans data\$sup75ans : objet de type 'closure' non indiçable}}

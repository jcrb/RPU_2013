...
\begin{itemize}\raggedright
  \item R version 3.0.2 (2013-09-25), \verb|i686-pc-linux-gnu|
...
Le SU Sainte Anne a reçu en 2013 un total de \np{12 139} consultants, soit en moyenne 1 317 par jour.

% latex table generated in R 3.0.2 by xtable 1.7-1 package
% Sun Mar  2 18:39:16 2014
\begin{table}[ht]
\centering
\begin{tabular}{rrrrrrrr}
  \hline
 & inf1an & entre1\_75ans & sup75ans & total & hospitalises & UHCD & tranferts \\ 
  \hline
n & 211.00 & 10611.00 & 1317.00 & 12139.00 & 4.00 & 1925.00 & 174.00 \\ 
  \% & 1.74 & 87.41 & 10.85 & 100.00 & 0.03 & 15.86 & 1.43 \\ 
   \hline
\end{tabular}
\end{table}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{ch} \hlkwb{<-} \hlstd{d1[d1}\hlopt{$}\hlstd{FINESS} \hlopt{==} \hlstr{"Col"}\hlstd{, ]}
\hlstd{x} \hlkwb{<-} \hlkwd{completude}\hlstd{(d1)}
\hlstd{y} \hlkwb{<-} \hlkwd{completude}\hlstd{(ch)}
\hlkwd{radar_completude}\hlstd{(x, y,} \hlkwc{ch.names} \hlstd{=} \hlstr{"CH Colmar"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## 0 100
\end{verbatim}

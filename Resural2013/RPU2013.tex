...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: la longueur de 'dimnames' [1] n'est pas égale à l'étendue du tableau}}\end{kframe}% latex table generated in R 3.1.0 by xtable 1.7-1 package
% Mon Apr 28 15:23:53 2014
\begin{table}[ht]
\centering
\begin{tabular}{rrrrrrr}
 ...
 & moyenne & écart-type & médiane & min & max & n \\ 
  \hline
1 & 70.87 & 19.41 & 77.00 & 0.00 & 98.00 & 841.00 \\ 
   \hline
\end{tabular}
...
Les pneumonies bactériennes concernent les adultes âgés des deux sexes. L'âge moyen est de 0 ans et la moitié de ces patients ont 77 ans et plus (table \ref{tab:pneumo_age} pp.\pageref{tab:pneumo_age}).
...
% Date and time: lun., avril 28, 2014 - 15:24:09

...
x <- xtable(t, caption=c("Moyens de transport utilisés pour se rendre à l'hôpital. Les deux colonnes de droite mesurent la fréquence du moyen utilise (en pourcentage) selon que l'on prenne en compte ou non les valeurs manquantes. ","Moyens de transport"),label="transport")
print(x,format.args = list(big.mark = " ", decimal.mark = ","))
@

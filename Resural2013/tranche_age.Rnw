...
doc <- doc[-nrow(doc),]
print(xtable(doc, caption=c("Population d'Alsace en 2010 (source INSEE)","Population d'Alsace en 2010"), label="tab:pop_insee"),format.args = list(big.mark = " ", decimal.mark = ","))
@

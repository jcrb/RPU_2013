...
a <- rbind(t1,t2)
rownames(a) <- c("n", "%")
xtable(a, caption="Répartition en trois classe d'âge telles qu'elles sont définies par le serveur régional de veille et d'alerte", label="tranche_age2")
@

...
stargazer(as.data.frame(data$entre1_75ans),summary=TRUE,digit.separator=" ",digits=2,median=TRUE,iqr=TRUE, title ="Se 1 à 75 ans: résumé des principales caractéristiques")

...
SpatialPolygonsRescale(layout.north.arrow(1), offset= c(900000,6850000), scale = 15000, col="grey",plot.grid=F)
...
SpatialPolygonsRescale(layout.scale.bar(), offset=c(1100000,6750000), height = 0.05, scale=50000, fill=c("transparent","black"), plot.grid=F)
...
# Legend
legend("topleft", legend=c("Pas de tension","Surcharge","Tension avérée","Pas d'informations"), col=c("green","orange","red","grey"), pch=15)
